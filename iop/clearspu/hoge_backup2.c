...
static vu32 *_spu_madr = (vu32 *)0xBF8010C0;
static vu32 *_spu_bcr = (vu32 *)0xBF8010C4;
static vu32 *_spu_chcr = (vu32 *)0xBF8010C8;
static vu32 *_spu_sys_pcr = (vu32 *)0xBF8010F0;
static vu32 *_spu_delay = (vu32 *)0xBF801014;
...
void *spuFunc(unsigned int command, void *data, int size)
{
  ...
  switch (command)
  {
    ...
    case 0x0002: ret = SpuSetCore(*((u32 *)data + 1)); break;
    case 0x0005: SpuSetKey(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x0006: ret = SpuSetReverb(*((u32 *)data + 1)); break;
    case 0x0007: ret = SpuClearReverbWorkArea(*((u32 *)data + 1)); break;
    case 0x0008: SpuSetReverbEndAddr(*((u32 *)data + 1)); break;
    case 0x000A: SpuSetReverbModeDepth(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x000B: ret = SpuSetReverbVoice(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x000C: ret = SpuSetIRQ(*((u32 *)data + 1)); break;
    case 0x000D: ret = SpuSetIRQAddr(*((u32 *)data + 1)); break;
    case 0x000E: ret = SpuSetTransferMode(*((u32 *)data + 1)); break;
    case 0x0010: ret = SpuSetTransferStartAddr(*((u32 *)data + 1)); break;
    case 0x0011: ret = SpuWrite(*((u8 **)data + 1), *((u32 *)data + 2)); break;
    case 0x0012: ret = SpuWrite0(*((u32 *)data + 1)); break;
    case 0x0013: ret = SpuIsTransferCompleted(*((u32 *)data + 1)); break;
    case 0x0017: ret = SpuGetReverbEndAddr(); break;
    case 0x0018: ret = SpuWritePartly(*((u8 **)data + 1), *((u32 *)data + 2)); break;
    case 0x0019: SpuInitHot(); break;
    case 0x001A: ret = SpuIsReverbWorkAreaReserved(*((u32 *)data + 1)); break;
    case 0x001B: ret = SpuMallocWithStartAddr(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x001C: ret = SpuRead(*((u8 **)data + 1), *((u32 *)data + 2)); break;
    case 0x001D: ret = SpuReadDecodedData(*((SpuDecodedData **)data + 1), *((u32 *)data + 2)); break;
    case 0x001E: ret = SpuReserveReverbWorkArea(*((u32 *)data + 1)); break;
    case 0x0020: ret = SpuSetMute(*((u32 *)data + 1)); break;
    case 0x0021: ret = SpuSetNoiseClock(*((u32 *)data + 1)); break;
    case 0x0022: ret = SpuSetNoiseVoice(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x0023: ret = SpuSetPitchLFOVoice(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x0024: ret = SpuStGetStatus(); break;
    case 0x0025: ret = SpuStGetVoiceStatus(); break;
    case 0x0100: ret = SpuInitMalloc(*((u32 *)data + 1), spu_malloc_rec); break;
    case 0x0101: ret = SpuMalloc(*((u32 *)data + 1)); break;
    case 0x0200:
    {
    ...
    case 0x0203: ret = SpuStSetCore(*((u32 *)data + 1)); break;
    case 0x100C: ret = SpuGetIRQAddr(); break;
    case 0x1010: ret = SpuFlush(*((u32 *)data + 1)); break;
    case 0x1011: SpuFree(*((u32 *)data + 1)); break;
    ...
    case 0x101C: ret = SpuGetKeyStatus(*((u32 *)data + 1)); break;
    case 0x1020:
    {
#ifdef LIB_OSD_100
    ...
    case 0x1023: SpuSetAutoDMAAttr(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6), *((u16 *)data + 8)); break;
    case 0x1024: SpuSetSerialInAttr(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x1030: gMultiVoiceNum = *((u32 *)data + 1); break;
    case 0x1031: SpuSetDigitalOut(*((u32 *)data + 1)); break;
    case 0x4001: ret = SsBlockVoiceAllocation(); break;
    case 0x4002: SsEnd(); break;
    case 0x4003: SsChannelMute(*((u16 *)data + 2), *((u16 *)data + 4), *((u32 *)data + 3)); break;
    case 0x4004: ret = SsGetActualProgFromProg(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4005: ret = SsGetChannelMute(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4006: ret = (int)SsGetCurrentPoint(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4007: ret = SsGetVoiceMask(); break;
    case 0x4008: SsInit(); break;
    case 0x4009: ret = SsIsEos(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x400A: SsAllocateVoices(*((u8 *)data + 4), *((u8 *)data + 8)); break;
    case 0x4010: SsPitchCorrect(*((u16 *)data + 2)); break;
    case 0x4011: ret = (u16)SsPitchFromNote(*((u16 *)data + 2), *((u16 *)data + 4), *((u8 *)data + 12), *((u8 *)data + 16)); break;
    case 0x4012: SsPlayBack(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x4013: SsQueueKeyOn(*((u32 *)data + 1)); break;
    case 0x4014: SsQueueReverb(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x4015: SsQuit(); break;
    case 0x4017: SsSetTableSize(seq_table, *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x4018: SsSetTickMode(*((u32 *)data + 1)); break;
    case 0x4019: SsSepClose(*((u16 *)data + 2)); break;
    case 0x4020: ret = SsSepOpen((unsigned int *)data + 1, *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x4021: SsSepPause(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4022: SsSepPlay(*((u16 *)data + 2), *((u16 *)data + 4), *((u8 *)data + 12), *((u16 *)data + 8)); break;
    case 0x4023: SsSepReplay(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4024: SsSepSetAccelerando(*((u16 *)data + 2), *((u16 *)data + 4), *((u32 *)data + 3), *((u32 *)data + 4)); break;
    case 0x4025: SsSepSetCrescendo(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6), *((u32 *)data + 4)); break;
    case 0x4026: SsSepSetDecrescendo(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6), *((u32 *)data + 4)); break;
    case 0x4027: SsSepSetRitardando(*((u16 *)data + 2), *((u16 *)data + 4), *((u32 *)data + 3), *((u32 *)data + 4)); break;
    case 0x4028: SsSepSetVol(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6), *((u16 *)data + 8)); break;
    case 0x4029: SsSepStop(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4030: SsSeqGetVol(*((u16 *)data + 2), *((u16 *)data + 4), (s16 *)data + 6, (s16 *)data + 8); break;
    case 0x4031: ret = SsSeqOpen(*((unsigned int **)data + 1), *((u16 *)data + 4)); break;
    case 0x4032: SsSeqPause(*((u16 *)data + 2)); break;
    case 0x4033: SsSeqPlayPtoP(*((u16 *)data + 2), *((u16 *)data + 4), *((u8 **)data + 3), *((u8 **)data + 4), *((u8 *)data + 20), *((u16 *)data + 12)); break;
    case 0x4034: SsSeqReplay(*((u16 *)data + 2)); break;
    case 0x4035: SsSeqSetAccelerando(*((u16 *)data + 2), *((u32 *)data + 2), *((u32 *)data + 3)); break;
    case 0x4036: SsSeqSetCrescendo(*((u16 *)data + 2), *((u16 *)data + 4), *((u32 *)data + 3)); break;
    case 0x4037: SsSeqSetDecrescendo(*((u16 *)data + 2), *((u16 *)data + 4), *((u32 *)data + 3)); break;
    case 0x4038: SsSeqSetRitardando(*((u16 *)data + 2), *((u32 *)data + 2), *((u32 *)data + 3)); break;
    case 0x4039: SsSeqSetNext(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4040: SsSeqCalledTbyT(); break;
    case 0x4041: SsSeqClose(*((u16 *)data + 2)); break;
    case 0x4042: SsSeqPlay(*((u16 *)data + 2), *((u8 *)data + 8), *((u16 *)data + 6)); break;
    case 0x4043: SsSeqSetVol(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x4044: SsSeqSkip(*((u16 *)data + 2), *((u16 *)data + 4), *((u8 *)data + 12), *((u16 *)data + 8)); break;
    case 0x4045: SsSeqStop(*((u16 *)data + 2)); break;
    case 0x4046: SsSetAutoKeyOffMode(*((u16 *)data + 2)); break;
    case 0x4047: SsSetCurrentPoint(*((u16 *)data + 2), *((u16 *)data + 4), *((u8 **)data + 3)); break;
    case 0x4048: SsSetLoop(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x4049: SsSetMono(); break;
    case 0x404A: SsSetMVol(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4050: SsSetNext(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6), *((u16 *)data + 8)); break;
    case 0x4051: ret = SsSetReservedVoice(*((u8 *)data + 4)); break;
    case 0x4052: SsSetStereo(); break;
    case 0x4053: SsSetTempo(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x4054: SsSetVoiceMask(*((u32 *)data + 1)); break;
    ...
    case 0x4059: ret = SsUtGetVagAddr(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x4060: ret = SsUtGetVagAddrFromTone(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x4061: ret = SsUtGetVBaddrInSB(*((u16 *)data + 2)); break;
    case 0x4062: SsVabClose(*((u16 *)data + 2)); break;
    case 0x4063: ret = SsVabOpenHead(*((u8 **)data + 1), *((u16 *)data + 4)); break;
    case 0x4064: ret = SsVabTransBodyPartly(*((u8 **)data + 1), *((u32 *)data + 2), *((u16 *)data + 6)); break;
    case 0x4065: ret = SsVabTransCompleted(*((u16 *)data + 2)); break;
    case 0x4066: SsVabTransBody(*((u8 **)data + 1), *((u16 *)data + 4)); break;
    case 0x4067: ret = SsVoiceCheck(*((u32 *)data + 1), *((u32 *)data + 2), *((u16 *)data + 6)); break;
    case 0x4068: ret = SsVoKeyOff(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x4069: ret = SsVoKeyOn(*((u32 *)data + 1), *((u32 *)data + 2), *((u16 *)data + 6), *((u16 *)data + 8)); break;
    case 0x4070: ret = SsVabOpenHeadSticky(*((u8 **)data + 1), *((u16 *)data + 4), *((u32 *)data + 3)); break;
#if 0
    case 0x5001: StInit(); break;
    case 0x5002: StQuit(); break;
    case 0x5003: StCalledVSync(); break;
    case 0x5005: ret = (s16)StVabOpen(*((s16 **)data + 1), *((u32 *)data + 2), *((u32 *)data + 3)); break;
    case 0x5006: ret = (s16)StVabOpenFakeBody(*((u32 *)data + 1), *((u32 *)data + 2)); break;
    case 0x5007: StVabOpenCompleted(); break; // CHECKME
    case 0x5008: ret = (s16)StVabClose(*((u16 *)data + 2)); break;
    case 0x5009: ret = (s16)StBgmOpen(*((u16 *)data + 2), *((u32 *)data + 2)); break; // CHECKME
    case 0x500A: StSetTickMode(*((u16 *)data + 2)); break;
    case 0x500B: ret = (s16)StBgmClose(*((u16 *)data + 2)); break;
    case 0x500C: StSetReverbType(*((u16 *)data + 2), *((u16 *)data + 4)); break; // CHECKME
    case 0x500D: StSetReverbDepth(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x500E: StSetReverbDelaytime(*((u16 *)data + 2), *((u16 *)data + 4)); break; // CHECKME
    case 0x500F: StSetReverbFeedback(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x5010: ret = StGetSlotStatus(*((u16 *)data + 2)); break;
    case 0x5011: StSetSbClear(*((u32 *)data + 1)); break; // CHECKME
    case 0x5012: StSetMasterVol(*((u16 *)data + 2), *((u16 *)data + 4), *((u16 *)data + 6)); break;
    case 0x5013: ret = (s16)StSetBgmVol(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x5014: StBgmPlay(*((u16 *)data + 2)); break; // CHECKME
    case 0x5015: StBgmStop(*((u16 *)data + 2), *((u16 *)data + 4), *((u32 *)data + 3)); break;
    case 0x5016: StSetBgmTempo(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x5017: ret = (s16)StGetBgmTempo(*((u16 *)data + 2)); break; // CHECKME
    case 0x5018: ret = (s16)StGetBgmStatus(); break;
    case 0x5019: ret = (s16)StGetBgmChStatus(); break; // CHECKME
    case 0x501A: ret = (s16)StDmaWrite(*((s16 **)data + 1), *((u32 *)data + 2), *((u32 *)data + 3)); break;
    case 0x501B: ret = (s16)StDmaRead(*((u32 *)data + 1), *((u8 **)data + 2), *((u32 *)data + 3)); break;
    case 0x5100: ret = SetTimer(&common); break;
    case 0x5101: ret = ReleaseTimer(); break;
    case 0x5200: ret = StSePlay(*((u16 *)data + 2), *((u16 *)data + 4)); break;
    case 0x5201: ret = StSetSeVol(*((u16 *)data + 2), *((u16 *)data + 4)); break;
#endif
    case 0x6128:
    {
...
void _spu2_config_iop(void)
{
  ...
  *_spu_sys_pcr |= 0x80000u;
  *((vu32 *)0xBF801570) |= 8u;
  *_spu_delay = 0x200B31E1;
...
int _spu_FiAutoDMA(void *userdata)
{
  ...
  if ( gMode != SPU_AUTODMA_ONESHOT )
  {
    ...
    if ( gWhichBuff )
      *_spu_madr = (u32)&gHostAddr[512 * (gBufferSize48 / 512)];
    else
      *_spu_madr = (u32)&gHostAddr[0];
    if ( gWhichBuff )
    {
      int v1;
      int v2;
...
int _spu_t(int count, ...)
{
  ...
  switch (count)
  {
    ...
    case 3:
      ...
      _spu_madr[272] = spu_tmp;
      _spu_bcr[272] = (_spu_transfer_time << 16) | 0x10;
      v6 = 0x1000201;
      if ( _spu_dma_mode == 1 )
        v6 = 16777728;
      _spu_chcr[272] = v6;
...
static void _spu_FsetDelayW(int flag)
{
  _spu_delay[256 * flag] = (_spu_delay[256 * flag] & ~0x2f000000) | 0x20000000;
}

static void _spu_FsetDelayR(int flag)
{
  _spu_delay[256 * flag] = (_spu_delay[256 * flag] & ~0x2f000000) | 0x22000000;
}
  ...
  for ( counter_1 = 0; counter_1 <= _spu_AllocLastNum; counter_1 += 1 )
  {
    while ( (_spu_memList[counter_1].addr_area & 0x80000000) != 0 )
    {
      ...
      if ( (p_cur_block_2->addr_area & 0x80000000) != 0
        && (p_cur_block_2->addr_area & 0xFFFFFFF) == (_spu_memList[counter_1].addr_area & 0xFFFFFFF) + _spu_memList[counter_1].size_area )
      {
...
int SpuMalloc(int size)
{
  ...
  else
  {
    ...
    {
      if ( !((_spu_memList[cur_idx].addr_area & 0x40000000) == 0
...
int SpuSetReverbModeParam(SpuReverbAttr *attr)
{
  ...
  if ( ((mask & SPU_REV_DELAYTIME) != 0) && _spu_rev_attr.mode <= SPU_REV_MODE_DELAY && _spu_rev_attr.mode >= SPU_REV_MODE_ECHO )
  {
    int delay_converted;
  ...
  if ( ((mask & SPU_REV_FEEDBACK) != 0) && _spu_rev_attr.mode <= SPU_REV_MODE_DELAY && _spu_rev_attr.mode >= SPU_REV_MODE_ECHO )
  {
...
u16 _spu_note2pitch(u16 cen_note_high, u16 cen_note_low, u16 note_high, u16 note_low)
{
  ...
  return (unsigned int)(((_spu_NTable[calc_note_mod12_idx] * (u16)_spu_FTable[max_lo_idx]) >> 16)
                      + (1 << (-(s16)calc_note_div12_min12 - 1))) >> -(s16)calc_note_div12_min12;
}
    ...
    if ( (arg->voice & (1 << voice_num)) != 0 )
    {
      ...
      if ( (attr_mask & SPU_VOICE_ADSR_AR) != 0 )
      {
        ...
        if ( ((attr_mask & SPU_VOICE_ADSR_AMODE) != 0) && arg->a_mode == SPU_VOICE_EXPIncN )
          adsr_ar_part = 128;
        _spu_RXX[512 * _spu_core + 3 + converted_voice_num] = (u8)_spu_RXX[512 * _spu_core
                                                                                      + 3
      ...
      if ( (attr_mask & SPU_VOICE_ADSR_DR) != 0 )
      {
        ...
        if ( adsr_dr_part >= 0x10 )
          adsr_dr_part = 15;
        _spu_RXX[512 * _spu_core + 3 + converted_voice_num] = (_spu_RXX[512 * _spu_core + 3 + converted_voice_num] & ~0xf0) | (16 * adsr_dr_part);
      }
      if ( (attr_mask & SPU_VOICE_ADSR_SR) != 0 )
      {
        ...
        _spu_RXX[512 * _spu_core + 4 + converted_voice_num] = (_spu_RXX[512 * _spu_core + 4 + converted_voice_num] & 0x3F) | (((u16)adsr_sr_part | (u16)converted_s_mode) << 6);
      }
      if ( (attr_mask & SPU_VOICE_ADSR_RR) != 0 )
      {
        ...
        _spu_RXX[512 * _spu_core + 4 + converted_voice_num] = (_spu_RXX[512 * _spu_core + 4 + converted_voice_num] & ~0x3f) | adsr_rr_part | attr_r_mode_converted;
      }
      if ( (attr_mask & SPU_VOICE_ADSR_SL) != 0 )
      {
        ...
        if ( attr_sl >= 0x10 )
          attr_sl = 15;
        _spu_RXX[512 * _spu_core + 3 + converted_voice_num] = (_spu_RXX[512 * _spu_core + 3 + converted_voice_num] & ~0xF) | attr_sl;
      }
    }
  }
  ...
  for ( i = min_; i < v8; i += 1 )
  {
    if ( (arg->voice & (1 << i)) != 0 )
    {
      ...
      if ( (attr_mask & SPU_VOICE_ADSR_AR) != 0 )
      {
        ...
        if ( ((attr_mask & SPU_VOICE_ADSR_AMODE) != 0) && arg->a_mode == SPU_VOICE_EXPIncN )
          v20 = 128;
        _spu_RXX[512 * _spu_core + 3 + v11] = (u8)_spu_RXX[512 * _spu_core + 3 + v11] | (u16)(((u16)ar | (u16)v20) << 8);
      }
      if ( (attr_mask & SPU_VOICE_ADSR_DR) != 0 )
      {
        dr = arg->dr;
      ...
      if ( (attr_mask & SPU_VOICE_ADSR_SR) != 0 )
      {
        ...
        _spu_RXX[512 * _spu_core + 4 + v11] = (_spu_RXX[512 * _spu_core + 4 + v11] & 0x3F) | (((u16)sr | (u16)v23) << 6);
      }
      if ( (attr_mask & SPU_VOICE_ADSR_RR) != 0 )
      {
        rr = arg->rr;
...
void SpuLSetVoiceAttr(int num, SpuLVoiceAttr *arg_list)
{
  ...
  for ( v3 = 0; v3 < num; v3 += 1 )
  {
    ...
    if ( (attr_mask & SPU_VOICE_NOTE) != 0 )
    {
      ...
      _spu_RXX[512 * _spu_core + 2 + v7] = _spu_note2pitch(
                                             v9 >> 8,
                                             (u8)v9,
...
void SpuGetVoiceAttr(SpuVoiceAttr *arg)
{
  ...
  if ( v2 != -1 )
  {
    ...
    arg->pitch = v16[2];
    v17 = _spu_pitch2note(
            (_spu_voice_centerNote[_spu_core][v2] >> 8) & 0xFF,
            (u8)_spu_voice_centerNote[_spu_core][v2],
            arg->pitch);
    if ( v17 < 0 )
      arg->note = 0;
    else
...
void _SsSetPitchBend(s16 sep_no, s16 seq_no)
{
  ...
  score_struct->m_seq_ptr += 1;
  _SsVmPitchBend(sep_no | (seq_no << 8), (char)score_struct->m_vab_id, (u8)score_struct->m_programs[score_struct->m_channel_idx], midi_byte);
  score_struct->m_delta_value = _SsReadDeltaValue(sep_no, seq_no);
}
...
void _SsNoteOn(s16 sep_no, s16 seq_no, u8 note, u8 vollr)
{
  ...
  if ( vollr == 0 )
  {
    _SsVmKeyOff(sep_no | (u16)(seq_no << 8), (char)score_struct->m_vab_id, (u8)score_struct->m_programs[m_channel_idx], note);
  }
...
void SsSetTableSize(char *table, s16 s_max, s16 t_max)
{
  ...
  {
    _ss_score[typed_table_i] = (libsnd2_sequence_struct_t *)&table[sizeof(libsnd2_sequence_struct_t) * (t_max * typed_table_i)];
  }
...
void SsUtAllKeyOff(s16 mode)
{
  ...
  voice_attr.mask = SPU_VOICE_VOLL | SPU_VOICE_VOLR | SPU_VOICE_PITCH | SPU_VOICE_WDSA | SPU_VOICE_ADSR_ADSR1 | SPU_VOICE_ADSR_ADSR2;
...
s16 SsUtChangeADSR(s16 vc, s16 vab_id, s16 prog, s16 old_note, u16 adsr1, u16 adsr2)
{
  ...
  if ( voice_struct->m_vab_id != vab_id
    || voice_struct->m_prog != prog
    || voice_struct->m_note != old_note )
  {
    return -1;
  }
...
void _SsVmFlush(void)
{
  ...
  for (v12 = 0; v12 < 24; v12 += 1)
  {
    ...
    if ( (_svm_sreg_dirty[v12] & 8) != 0 )
    {
      ...
      voice_attr.addr = (_svm_sreg_buf2[v12].m_vag_spu_addr << 4)
                      + (_svm_sreg_buf2[v12].m_vab_spu_offset << 20);
    }
...
int _SsVmKeyOff(int seq_sep_no, s16 vab_id, s16 prog, s16 note)
{
  ...
  for ( v4 = 0; (u8)v4 < _SsVmMaxVoice; v4 += 1 )
  {
    ...
    voice_struct = &_svm_voice[v4];
    if ( !((_snd_vmask & (1 << v4)) != 0
      || voice_struct->m_note != note
      || voice_struct->m_prog != prog
      || voice_struct->m_seq_sep_no != (s16)seq_sep_no
      || voice_struct->m_vab_id != vab_id) )
    {
      v5 += 1;
...
u16 SsPitchFromNote(s16 note, s16 fine, u8 center, u8 shift)
{
  ...
  if ( v10 >= 0 )
    return 0x3FFF;
  return (unsigned int)(((_svm_ntable[v11]
                        * _svm_ftable[shift_plus_fine_mod_tmp]) >> 16)
                      + (1 << (-v10 - 1))) >> -v10;
}
...
int _SsVmPBVoice(s16 vc, s16 seq_sep_num, s16 vab_id, s16 prog, s16 pitch)
{
  ...
  if ( pitch_converted <= 0 )
  {
    ...
    else
    {
      ...
      pbmin_tmp = pitch_converted
                * _svm_tn[(u16)(voice_struct->m_tone + 16 * _svm_cur.m_fake_program)].pbmin;
  ...
  else
  {
    ...
    pbmax_tmp = pitch_converted
              * _svm_tn[(u16)(voice_struct->m_tone + 16 * _svm_cur.m_fake_program)].pbmax;
...
int _SsVmPitchBend(s16 seq_sep_no, int vab_id, int prog, s16 pitch)
{
  ...
  {
    voice_offs_tmp += (s16)_SsVmPBVoice(
                                 voice_i_tmp,
                                 seq_sep_no,
                                 vab_id,
                                 prog,
    ...
    if ( (_snd_vmask & (1 << v5)) == 0 )
    {
      ...
      if ( voice_struct->m_seq_sep_no == seq_sep_num )
      {
        ...
        if ( m_vab_id == (char)score_struct->m_vab_id )
        {
          ...
          vol_factor = _svm_vh->mvol
                     * 0x3FFF
                     * (voice_struct->m_voll1
                      * score_struct->m_vol[voice_struct->m_channel_idx]
                      / 127)
                     / 0x3F01
                     * _svm_pg[voice_struct->m_prog].mvol
                     * vag_attr_ptr->vol;
...
int _SsVmSetVol(s16 seq_sep_no, s16 vab_id, s16 prog, s16 voll, s16 volr)
{
  ...
  for ( v13 = 0; (s16)v13 < _SsVmMaxVoice; v13 += 1 )
  {
    if ( (_snd_vmask & (1 << v13)) == 0 )
    {
      ...
      if ( voice_struct->m_seq_sep_no == seq_sep_no && voice_struct->m_prog == prog && voice_struct->m_vab_id == vab_id )
      {
        v20 = score_struct->m_vol[score_struct->m_channel_idx];
        if ( (v20 != 0) || (v20 != (u16)voll) )
        {
          vag_attr_ptr = &_svm_tn[16 * voice_struct->m_fake_program + voice_struct->m_tone];
          volcalc = voice_struct->m_voll1
                  * (u16)voll
                  / 127
                  * 0x3FFF
                  * _svm_vh->mvol
