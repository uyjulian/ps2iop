...
#define ICFG     (*(vu32 *)0xbf801450)
#define IREG     (*(vu32 *)0xbf801070)
#define IMASK    (*(vu32 *)0xbf801074)
#define ICTRL    (*(vu32 *)0xbf801078)
#define DMA_ICR  (*(vu32 *)0xbf8010F4)
#define DMA_ICR2 (*(vu32 *)0xbf801574)

#define EXCEP_CAUSE (*(vu32 *)0x40C)
...
//
int RegisterIntrHandler(int interrupt, int mode, int (*handler)(void *), void *arg)
{
    int ictrl;
...
{
    unsigned char *_sp = (unsigned char *)sp;
    int retval = 0;
    if ((_sp < tempstack + INTR_STACK_SIZE) && (_sp > tempstack)) {
        retval = 1;
    }
    return retval;
}
...
extern exception_handler_struct_t EXCEP_Int_priority_exception_handler;
extern exception_handler_struct_t EXCEP_Int_handler;
extern exception_handler_struct_t EXCEP_Sys_handler;
